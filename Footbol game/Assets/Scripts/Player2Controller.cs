...
public class Player2Controller : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        // controls.Player2.Pass.performed += OnPass;

        // Set up shoot charging on key down and release on key up
        controls.Player2.Shoot.started += OnShootStarted;
        controls.Player2.Shoot.canceled += OnShootReleased;
    }
    ...
    private void OnShootStarted(InputAction.CallbackContext context)
    {
        if (IsBallInRange())
        {
            ...
            Debug.Log("Player 2 Shoot Charging...");
        }
    }
    ...
    private void OnShootReleased(InputAction.CallbackContext context)
    {
        if (isChargingShoot && IsBallInRange())
        {
            ...
            Debug.Log("Player 2 Shoot with force: " + dynamicShootForce + " in direction: " + directionToBall);
